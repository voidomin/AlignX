...
class TestPipelineIntegration:
    ...
    def test_download_and_clean_integration(self, mock_config, temp_workspace, dummy_pdb_content):
        """
        ...
        with patch.object(manager, 'download_pdb') as mock_dl:
            # Simulate successful download to a file
            ...
            # 1. Download (Mocked)
            success, msg, raw_path = manager.download_pdb("1DUM")
