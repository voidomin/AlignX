...
[![Version](https://img.shields.io/badge/version-3.95.0-orange.svg)](CHANGELOG.md)
...
Backend (pytest, 1343 tests):
```powershell
powershell -File scripts\run_tests.ps1
```

Frontend (Vitest, 533 tests):
```powershell
cd web-frontend
npm test
```
...
| [docs/deployment/DEPLOYMENT.md](docs/deployment/DEPLOYMENT.md) | Free Vercel + Render split deploy, Docker deployment (SPA + FastAPI), Streamlit Cloud/Hugging Face deployment |
