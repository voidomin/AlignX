...
npm test
```
*Expected Output:* all test files pass (currently 225 tests across the suite, covering `api.js` and every tab/panel component, including `DiscoverTab.js` and `SettingsTab.js`).
