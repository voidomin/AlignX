...
```
*Expected Output:*
- Pytest runs 244 items successfully and shows no errors.
...
npm test
```
*Expected Output:* all test files pass (currently 122 tests across the suite, covering `api.js` and every tab/panel component, including `DiscoverTab.js`).
