(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`http://127.0.0.1:8000`;async function t(){let t=await fetch(`${e}/health`);if(!t.ok)throw Error(`Health check failed`);return t.json()}async function n(t){let n=await fetch(`${e}/api/suggest?q=${encodeURIComponent(t)}`);if(!n.ok)throw Error(`Suggestions fetch failed`);return n.json()}async function r(t){let n=await fetch(`${e}/api/chains`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({pdb_ids:t})});if(!n.ok){let e=await n.json();throw Error(e.detail||`Chains fetch failed`)}return n.json()}async function i(t,n,r,i){let a=await fetch(`${e}/api/align`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({pdb_ids:t,chain_selection:n,remove_water:r,remove_heteroatoms:i})});if(!a.ok){let e=await a.json();throw Error(e.detail||`Alignment execution failed`)}return a.json()}async function a(t,n){let r=await fetch(`${e}/api/ligands?pdb_id=${t}&run_id=${n}`);if(!r.ok)throw Error(`Ligands fetch failed`);return r.json()}async function o(t,n,r){let i=await fetch(`${e}/api/interactions?pdb_id=${t}&ligand_id=${n}&run_id=${r}`);if(!i.ok)throw Error(`Interactions fetch failed`);return i.json()}async function s(){let t=await fetch(`${e}/api/memory`);if(!t.ok)throw Error(`Memory stats fetch failed`);return t.json()}async function c(){let t=await fetch(`${e}/api/memory/clear`,{method:`POST`});if(!t.ok)throw Error(`Clear memory execution failed`);return t.json()}async function l(){let t=await fetch(`${e}/api/history`);if(!t.ok)throw Error(`History fetch failed`);return t.json()}async function u(t){let n=await fetch(`${e}/api/sequence?run_id=${t}`);if(!n.ok)throw Error(`Sequence alignment fetch failed`);return n.json()}function d(t){return`${e}/results/${t}/alignment.pdb`}function f(t){return`${e}/results/${t}/alignment.fasta`}function p(t){return`${e}/api/report?run_id=${t}`}var m=class{constructor(e){this.onAddPDB=e.onAddPDB,this.onRunAlignment=e.onRunAlignment,this.onExportData=e.onExportData,this.element=null,this.suggestTimeout=null}render(){let e=document.createElement(`header`);return e.className=`flex items-center justify-between px-6 w-full sticky top-0 z-50 bg-surface/70 backdrop-blur-xl h-16 border-b border-white/10 shadow-sm shrink-0 glass-panel`,e.innerHTML=`
        ...
        `;try{let s=this.selectedPDBs[0],c=(await o(s,e,this.currentRunId)).interactions,l=c.interactions;this.onLigandSelected(e,l),n.innerText=`Conserved catalytic pocket near ligand ${c.ligand}. Stable hydrophobic cluster showing coordinated interactions.`,c.pocket_volume?(i.innerText=`Volume: ${c.pocket_volume.toFixed(1)} Å³`,i.classList.remove(`hidden`)):i.classList.add(`hidden`),c.pocket_sasa?(a.innerText=`SASA: ${c.pocket_sasa.toFixed(1)} Å²`,a.classList.remove(`hidden`)):a.classList.add(`hidden`),r.innerText=`${l.length} Found`,t.innerHTML=``,l.length===0?t.innerHTML=`
            ...
            `}}},b=class{constructor(){this.currentRunId=null,this.element=null,this.stats={rmsd:null,aligned_length:null,seq_identity:null,seq_similarity:null}}render(){let e=document.createElement(`div`);return e.className=`flex-grow flex flex-col gap-4 overflow-y-auto pr-1`,e.id=`tab-sequence-container`,e.innerHTML=`
        ...
        `;try{let{sequences:t,conservation:n}=await u(this.currentRunId),r=``,i={identity:`#ff4757`,high_similarity:`#ffa502`,gap:`#2f3542`,default:`transparent`};Object.keys(t).forEach(e=>{let a=t[e],o=``;for(let e=0;e<a.length;e++){let t=a[e],r=n[e],s=i.default;t===`-`?s=i.gap:r===1?s=i.identity:r>.7&&(s=i.high_similarity),o+=`<td class="${r>.5||t===`-`?`res-val`:``} text-center font-mono border border-white/5" style="background-color: ${s}; min-width: 22px; height: 24px; font-size: 12px; color: #fff;">${t}</td>`}r+=`
            ...
            `}}},x=class{constructor(){this.element=null,this.currentRunId=null,this.heatmapFig=null,this.treeFig=null,this.ramachandranStats=null,this.rmsfValues=[]}render(){let e=document.createElement(`div`);return e.className=`flex-grow flex flex-col gap-4 overflow-y-auto pr-1`,e.id=`tab-analytics-container`,e.innerHTML=`
        ...
        `,this.element=e,this.renderVisuals(),e}updateResults(e,t,n,r,i){this.currentRunId=e,this.heatmapFig=t,this.treeFig=n,this.ramachandranStats=r,this.rmsfValues=i||[],this.renderVisuals()}renderVisuals(){if(!this.element)return;let e=this.element.querySelector(`#ramachandran-score`),t=this.element.querySelector(`#ramachandran-outliers`),n=this.element.querySelector(`#ramachandran-outliers-list-card`),r=this.element.querySelector(`#ramachandran-outliers-list`);this.ramachandranStats&&this.ramachandranStats.favored_percent!=null?(e.innerText=`${this.ramachandranStats.favored_percent.toFixed(1)}%`,t.innerText=this.ramachandranStats.outlier_count,this.ramachandranStats.outlier_count>0&&this.ramachandranStats.outliers_list&&this.ramachandranStats.outliers_list.length>0?(n.classList.remove(`hidden`),r.innerHTML=``,this.ramachandranStats.outliers_list.forEach(e=>{let t=document.createElement(`span`);t.className=`px-2 py-0.5 rounded bg-error/10 border border-error/20 text-error font-mono text-[10px]`,t.innerText=e,r.appendChild(t)})):n.classList.add(`hidden`)):(e.innerText=`--`,t.innerText=`--`,n.classList.add(`hidden`));let i=this.element.querySelector(`#rmsf-plotly-chart`);if(this.rmsfValues&&this.rmsfValues.length>0){i.innerHTML=``;let e={x:Array.from({length:this.rmsfValues.length},(e,t)=>t+1),y:this.rmsfValues,type:`scatter`,mode:`lines`,line:{color:`#8B5CF6`,width:2.5,shape:`spline`},fill:`tozeroy`,fillcolor:`rgba(139, 92, 246, 0.1)`,hoverinfo:`x+y`,name:`RMSF`};Plotly.newPlot(i,[e],{xaxis:{title:`Alignment Position`,gridcolor:`rgba(255,255,255,0.05)`,zeroline:!1},yaxis:{title:`RMSF (Å)`,gridcolor:`rgba(255,255,255,0.05)`,zeroline:!1},margin:{l:50,r:20,t:20,b:40},paper_bgcolor:`rgba(0,0,0,0)`,plot_bgcolor:`rgba(0,0,0,0)`,height:280,font:{family:`Inter, sans-serif`,size:10,color:`#8F9CAE`}},{responsive:!0,displayModeBar:!1})}else this.currentRunId&&(i.innerHTML=`
            ...
            `)}},S=class{constructor(e){this.onReloadRun=e.onReloadRun,this.onClose=e.onClose,this.element=null,this.runsList=[]}render(){let e=document.createElement(`div`);return e.className=`flex-grow flex flex-col h-full overflow-hidden p-5`,e.innerHTML=`
            <!-- Panel Header -->
