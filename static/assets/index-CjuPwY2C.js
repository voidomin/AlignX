(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`http://127.0.0.1:8000`;async function t(){let t=await fetch(`${e}/health`);if(!t.ok)throw Error(`Health check failed`);return t.json()}async function n(t){let n=await fetch(`${e}/api/suggest?q=${encodeURIComponent(t)}`);if(!n.ok)throw Error(`Suggestions fetch failed`);return n.json()}async function r(t){let n=await fetch(`${e}/api/chains`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({pdb_ids:t})});if(!n.ok){let e=await n.json();throw Error(e.detail||`Chains fetch failed`)}return n.json()}async function i(t,n,r,i){let a=await fetch(`${e}/api/align`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({pdb_ids:t,chain_selection:n,remove_water:r,remove_heteroatoms:i})});if(!a.ok){let e=await a.json();throw Error(e.detail||`Alignment execution failed`)}return a.json()}async function a(t,n){let r=await fetch(`${e}/api/ligands?pdb_id=${t}&run_id=${n}`);if(!r.ok)throw Error(`Ligands fetch failed`);return r.json()}async function o(t,n,r){let i=await fetch(`${e}/api/interactions?pdb_id=${t}&ligand_id=${n}&run_id=${r}`);if(!i.ok)throw Error(`Interactions fetch failed`);return i.json()}async function s(){let t=await fetch(`${e}/api/memory`);if(!t.ok)throw Error(`Memory stats fetch failed`);return t.json()}async function c(){let t=await fetch(`${e}/api/memory/clear`,{method:`POST`});if(!t.ok)throw Error(`Clear memory execution failed`);return t.json()}async function l(){let t=await fetch(`${e}/api/history`);if(!t.ok)throw Error(`History fetch failed`);return t.json()}async function u(t){let n=await fetch(`${e}/api/sequence?run_id=${t}`);if(!n.ok)throw Error(`Sequence alignment fetch failed`);return n.json()}function d(t){return`${e}/results/${t}/alignment.pdb`}function f(t){return`${e}/results/${t}/alignment.fasta`}var p=class{constructor(e){this.onAddPDB=e.onAddPDB,this.onRunAlignment=e.onRunAlignment,this.onExportData=e.onExportData,this.element=null,this.suggestTimeout=null}render(){let e=document.createElement(`header`);return e.className=`flex items-center justify-between px-6 w-full sticky top-0 z-50 bg-surface/70 backdrop-blur-xl h-16 border-b border-white/10 shadow-sm shrink-0 glass-panel`,e.innerHTML=`
            <!-- Logo -->
        ...
        `;try{let s=this.selectedPDBs[0],c=(await o(s,e,this.currentRunId)).interactions,l=c.interactions;this.onLigandSelected(e,l),n.innerText=`Conserved catalytic pocket near ligand ${c.ligand}. Stable hydrophobic cluster showing coordinated interactions.`,c.pocket_volume?(i.innerText=`Volume: ${c.pocket_volume.toFixed(1)} Å³`,i.classList.remove(`hidden`)):i.classList.add(`hidden`),c.pocket_sasa?(a.innerText=`SASA: ${c.pocket_sasa.toFixed(1)} Å²`,a.classList.remove(`hidden`)):a.classList.add(`hidden`),r.innerText=`${l.length} Found`,t.innerHTML=``,l.length===0?t.innerHTML=`
            ...
            `}}},y=class{constructor(){this.currentRunId=null,this.element=null,this.stats={rmsd:null,aligned_length:null,seq_identity:null,seq_similarity:null}}render(){let e=document.createElement(`div`);return e.className=`flex-grow flex flex-col gap-4 overflow-y-auto pr-1`,e.id=`tab-sequence-container`,e.innerHTML=`
        ...
        `;try{let{sequences:t,conservation:n}=await u(this.currentRunId),r=``,i={identity:`#ff4757`,high_similarity:`#ffa502`,gap:`#2f3542`,default:`transparent`};Object.keys(t).forEach(e=>{let a=t[e],o=``;for(let e=0;e<a.length;e++){let t=a[e],r=n[e],s=i.default;t===`-`?s=i.gap:r===1?s=i.identity:r>.7&&(s=i.high_similarity),o+=`<td class="${r>.5||t===`-`?`res-val`:``} text-center font-mono border border-white/5" style="background-color: ${s}; min-width: 22px; height: 24px; font-size: 12px; color: #fff;">${t}</td>`}r+=`
            ...
            `}}},b=class{constructor(){this.element=null,this.currentRunId=null,this.heatmapFig=null,this.treeFig=null,this.ramachandranStats=null}render(){let e=document.createElement(`div`);return e.className=`flex-grow flex flex-col gap-4 overflow-y-auto pr-1`,e.id=`tab-analytics-container`,e.innerHTML=`
        ...
        `,this.element=e,this.setupEventListeners(),this.loadHistoryData(),e}setupEventListeners(){this.element.querySelector(`#close-history-btn`).addEventListener(`click`,()=>{this.onClose&&this.onClose()})}async loadHistoryData(){let e=this.element.querySelector(`#history-runs-list`);try{let t=await l();if(this.runsList=t.runs||[],e.innerHTML=``,this.runsList.length===0){e.innerHTML=`
            ...
            `,e.appendChild(t)}}navigateView(e){this.activeView=e,this.updateRightPaneDisplay()}switchTab(e){this.activeTab=e,this.tabPanel.switchTab(e),this.updateRightPaneDisplay()}async loadChainsMetadata(){if(this.selectedPDBs.length!==0){this.overviewTab.setLoadingChains(!0);try{let e=await r(this.selectedPDBs);Object.keys(e.chains).forEach(t=>{this.pdbMetadata[t]=e.chains[t],e.chains[t].chains&&e.chains[t].chains.length>0&&(this.chainSelections[t]||(this.chainSelections[t]=e.chains[t].chains[0].id))}),this.overviewTab.updateState(this.selectedPDBs,this.chainSelections,this.pdbMetadata)}catch(e){console.error(`Failed to load chain selection data:`,e)}finally{this.overviewTab.setLoadingChains(!1)}}}async addPDB(e){e=e.toUpperCase().trim(),e.length===4&&(this.selectedPDBs.includes(e)||(this.selectedPDBs.push(e),this.overviewTab.updateState(this.selectedPDBs,this.chainSelections,this.pdbMetadata),await this.loadChainsMetadata()))}removePDB(e){this.selectedPDBs=this.selectedPDBs.filter(t=>t!==e),delete this.chainSelections[e],this.overviewTab.updateState(this.selectedPDBs,this.chainSelections,this.pdbMetadata)}async executeAlignment(){if(this.selectedPDBs.length<2){alert(`At least 2 PDB structures are required for structural alignment.`);return}this.setAligningState(!0);let e=this.overviewTab.getParameters();try{let t=(await i(this.selectedPDBs,this.chainSelections,e.removeWater,e.removeHeteroatoms)).results;this.currentRunId=t.id,this.heatmapFig=t.heatmap_fig,this.treeFig=t.tree_fig,this.ramachandranStats=t.ramachandran_stats;let n=this.selectedPDBs[0],r=this.selectedPDBs[1];await this.viewer3D.loadSuperposition(t.id,n,r,this.chainSelections[n],this.chainSelections[r],t.stats.rmsd),this.currentLigands=[];let o=await a(n,t.id);this.currentLigands=o.ligands||[],this.ligandTab.updateLigands(this.currentLigands,t.id),this.sequenceTab.updateResults(t.id,t.stats),this.analyticsTab.updateResults(t.id,this.heatmapFig,this.treeFig,this.ramachandranStats),this.switchTab(`sequence`)}catch(e){console.error(`Alignment run failed:`,e),alert(`Alignment pipeline failed: ${e.message}`)}finally{this.setAligningState(!1)}}setAligningState(e){this.isAligning=e,this.topNav.setAligning(e),this.overviewTab.setAligning(e)}async reloadPastRun(e){this.activeView=`dashboard`,this.activeTab=`sequence`,this.currentRunId=e.id;let t=[];try{t=typeof e.pdb_ids==`string`?JSON.parse(e.pdb_ids):e.pdb_ids}catch{t=[e.pdb_ids]}this.selectedPDBs=t;let n={};try{n=typeof e.metadata==`string`?JSON.parse(e.metadata):e.metadata}catch{}this.chainSelections=n.chain_selection||{};let r={};n.results?(r=n.results.stats||{},this.heatmapFig=n.results.heatmap_fig||null,this.treeFig=n.results.tree_fig||null,this.ramachandranStats=n.results.ramachandran_stats||null):(r=n.stats||{},this.heatmapFig=null,this.treeFig=null,this.ramachandranStats=null);let i=r.rmsd||0;this.overviewTab.updateState(this.selectedPDBs,this.chainSelections,this.pdbMetadata),this.updateRightPaneDisplay();let o=this.selectedPDBs[0],s=this.selectedPDBs[1];await this.viewer3D.loadSuperposition(e.id,o,s,this.chainSelections[o]||`A`,this.chainSelections[s]||`A`,i),this.loadChainsMetadata(),this.currentLigands=[];try{let t=await a(o,e.id);this.currentLigands=t.ligands||[]}catch(e){console.error(`Failed to load ligands for past run:`,e)}this.ligandTab.updateLigands(this.currentLigands,e.id),this.sequenceTab.updateResults(e.id,r),this.analyticsTab.updateResults(e.id,this.heatmapFig,this.treeFig,this.ramachandranStats),this.switchTab(`sequence`)}resetWorkspace(){confirm(`Reset current workspace and clear selected structures?`)&&(this.selectedPDBs=[`4RLT`,`3UG9`],this.chainSelections={"4RLT":`A`,"3UG9":`A`},this.currentRunId=null,this.currentLigands=[],this.activeTab=`overview`,this.heatmapFig=null,this.treeFig=null,this.ramachandranStats=null,this.overviewTab.updateState(this.selectedPDBs,this.chainSelections,this.pdbMetadata),this.ligandTab.updateLigands([],null),this.sequenceTab.updateResults(null,null),this.analyticsTab.updateResults(null,null,null,null),this.viewer3D.resetCartoonStyles(),document.getElementById(`ambient-placeholder`).style.display=`flex`,document.getElementById(`hud-reference-label`).innerText=`Reference: --`,document.getElementById(`hud-target-label`).innerText=`Target: --`,document.getElementById(`rmsd-value-hud`).innerText=`-- Å`,this.switchTab(`overview`))}exportData(){if(!this.currentRunId){alert(`No active alignment result to export.`);return}window.open(getAlignmentPdbUrl(this.currentRunId),`_blank`)}}().render(document.getElementById(`app`));